...
volatile uint32_t c_correlation_cycles;
volatile uint32_t c_convolution_cycles;

volatile uint32_t cmsis_difference_cycles;
volatile uint32_t cmsis_statistics_cycles;
volatile uint32_t cmsis_correlation_cycles;
volatile uint32_t cmsis_convolution_cycles;
